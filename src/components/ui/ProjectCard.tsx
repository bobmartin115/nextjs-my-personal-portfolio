...
export const ProjectCard = React.memo(function ProjectCard({
  ...
  return (
    <>
      ...
      >
        {/* Image Container */}
        <div className="relative aspect-video w-full overflow-hidden flex-shrink-0 cursor-pointer group">
          <Image
            ...
            loading="lazy"
          />
          <div className="pointer-events-none absolute inset-0 bg-slate-950/0 group-hover:bg-slate-950/20 transition-colors duration-300" />
        </div>
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <div className="flex items-center gap-4">
            ...
            {project.link && (
              ...
              >
                <TbExternalLink size={16} /> Visit Site
              </Link>
            )}
          </div>
        </div>
